...
/**
 * Represents tests for methods and constructors in the rectangle class.
 */
public class RectangleTest {
   ...
   */
  private void init() {
    s1 = new Rectangle(new Shape.ShapeBuilder());
    s2 = new Rectangle(new Shape.ShapeBuilder().setKey("hi grader").setX(50).setY(20)
  ...
  public void testConstructorExceptionNullBuilder() {
    ...
    Shape shape = new Rectangle((Shape.ShapeBuilder) null);
  }
}